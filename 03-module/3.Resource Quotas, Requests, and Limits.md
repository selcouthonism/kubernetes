...
```
Listing ReplicaSets shows both the old and new ReplicaSets coexisting during the rolling update. The desired replica counts reflect Kubernetes’ attempt to maintain availability while updating. This dual presence increases temporary resource demand.
